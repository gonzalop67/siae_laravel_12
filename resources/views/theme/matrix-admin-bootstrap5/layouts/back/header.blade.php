        ...
        <div class="navbar-header" data-logobg="skin5">
            <a class="navbar-brand" href="index.html">
                <b class="logo-icon ps-2">
                    <img src="{{ asset('assets/back/' . $theme . '/images/logo-icon.png') }}" alt="homepage"
                        class="light-logo" width="25" />
                </b>
                <span class="logo-text ms-2">
                    <img src="{{ asset('assets/back/' . $theme . '/images/logo-text.png') }}" alt="homepage"
                        class="light-logo" />
                </span>
            </a>
            ...
            <ul class="navbar-nav float-end">
                ...
                <li class="nav-item dropdown">
                  ...
                  "
                        ...
                        aria-expanded="false">
                        <img src="{{ asset('assets/back/' . $theme . '/images/users/1.jpg') }}" alt="user"
